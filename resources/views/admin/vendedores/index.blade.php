...
@section('content')
	<div class="container">
			...
			<nav>
				<div class="nav-wrapper green">
					<div class="col s12">
						...
						<a class="breadcrumb">Lista de Vendedores</a>
					</div>
				</div>
			</nav>
		</div>
		...
		<div class="row">
                <a class="waves-effect waves-light btn blue" href="{{route('admin.vendedores.adicionar')}}"><i class="material-icons left">add_circle_outline</i>Adicionar</a>
		</div>
	</div>
        ...
        $( document ).ready(function() {
            $('tbody').on('click', '.del', function(){
                ...
                swal({
                    ...
                    location.href='/admin/vendedores/deletar/'+registroId;
            ...
            $('tbody').on('click', '.edit', function()
            {
                ...
                {
                    location.href='/admin/vendedores/editar/'+registroId;
